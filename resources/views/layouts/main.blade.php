    ...
    <header class="sticky top-0 z-50 bg-luxury-bg/95 backdrop-blur-md border-b border-white/5" x-data="{ openMob: false }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden md:flex space-x-8">
                    ...
                    <a href="#" class="text-sm tracking-widest uppercase hover:text-luxury-gold transition text-zinc-400">About</a>
                    <a href="#" class="text-sm tracking-widest uppercase hover:text-luxury-gold transition text-zinc-400">Contact</a>
                </nav>
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <form action="{{ url('/products') }}" method="GET" class="relative">
                        <input type="text" name="search" placeholder="Search timepiece..." 
                               ...
                               class="bg-zinc-900/80 border border-white/10 rounded-full py-1.5 pl-4 pr-10 text-xs w-48 text-zinc-300 placeholder-zinc-500 focus:outline-none focus:border-luxury-gold transition duration-300">
                    ...
                    <!-- Cart Link -->
                    <a href="{{ url('/cart') }}" class="relative text-zinc-400 hover:text-luxury-gold transition duration-300">
        ...
        <div x-show="openMob" x-cloak x-transition class="md:hidden bg-zinc-950/95 border-b border-white/10 px-4 pt-2 pb-6 space-y-3">
            <nav class="flex flex-col space-y-3 font-medium">
                ...
                <a href="#" class="text-sm tracking-wider uppercase text-zinc-400">About</a>
                <a href="#" class="text-sm tracking-wider uppercase text-zinc-400">Contact</a>
            </nav>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-zinc-700 bg-neutral-900 px-3 py-1 rounded inline-block">
                        Local Dev Environment (MySQL)
                    </p>
                </div>
                <!-- Categories Links -->
                <div>
                ...
                <div>
                    ...
                    <form class="flex gap-2">
                        <input type="email" placeholder="Your email address" class="bg-zinc-900 border border-white/5 px-3 py-2 text-xs text-zinc-300 w-full focus:outline-none focus:border-luxury-gold rounded">
                        <button type="submit" class="bg-luxury-gold text-black font-semibold text-xs tracking-wider px-4 py-2 hover:bg-luxury-goldLight transition rounded">Join</button>
                    </form>
                </div>
            </div>
